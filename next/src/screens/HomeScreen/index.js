...
import { Image, Box, Text, Icon, Input, Button } from "../../theme/componets";
import Head from "next/head";

const LOGO_ALURA_URL = "/images/alura.svg";
const SIDE_IMAGE_URL = "/images/c4-carrinhos.png";
...
export default function HomeScreen() {
  return (
    <Box>
      <Head>
        <title>Alura Case - Home Page</title>
      </Head>
      <Box
        as="main"
        styleSheet={{
